...
from research.arrow49 import EXPERIMENTS
...
def test_id0_short_only_and_3000_share_count() -> None:
    assert EXPERIMENTS[0][0] == "n8_h10_3k"
    assert EXPERIMENTS[0][1:] == (8, 10, 3000.0)
...
def test_4k_5k_6k_share_counts_match_notional() -> None:
    assert EXPERIMENTS[1][0] == "n8_h10_4k"
    assert EXPERIMENTS[1][3] == 4000.0
    assert EXPERIMENTS[2][0] == "n8_h10_5k"
    assert EXPERIMENTS[2][3] == 5000.0
    assert EXPERIMENTS[3][0] == "n8_h10_6k"
    assert EXPERIMENTS[3][3] == 6000.0
    ...
    assert shares_for(20.0, 6000.0) != shares_for(20.0, 5000.0)
...
def test_h5_exit_is_five_sessions_h10_is_ten() -> None:
    ...
    assert EXPERIMENTS[4][0] == "n8_h5_4k"
    assert EXPERIMENTS[4][2] == 5
    assert EXPERIMENTS[5][0] == "n8_h5_5k"
